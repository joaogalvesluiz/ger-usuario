class UserController {
  ...
  constructor(formIdCreate, formIdUpdate, tableId) {
    this.formEl = document.getElementById(formIdCreate); // form id
    this.formUpdateEl = document.getElementById(formIdUpdate); // form id
